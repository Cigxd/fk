  ...
  //////////qr code 
    ...
    if ($category == "fossil") {
        ...
        $update_query = "UPDATE product 
                 SET sub_category_id = $sub_category, 
                     `name` = '{$_POST['name']}', 
                     fossile_period = '{$_POST['period']}', 
                     price = '{$_POST['price']}', 
                     quantity = '{$_POST['quantity']}', 
                     `image` = '{$image_dir}', 
                     qr_code = '{$fileName}', 
          ...
          <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="view.php?id=<?php echo "$product_id";?>" enctype="multipart/form-data">
